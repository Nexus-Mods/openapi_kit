      ...
      class Codec
        ...
        def from_wire(value)
          ...
          KitchenSink::Types::Mod.new(
            ...
            updated_at: ::Oapi::Decode.field(raw, "updatedAt") { |v| ::Oapi::Codec::Primitive::DateTime::CODEC.from_wire(v) },
            deleted_at: ::Oapi::Decode.nullable_field(raw, "deletedAt") { |v| ::Oapi::Codec::Primitive::DateTime::CODEC.from_wire(v) },
            summary: ::Oapi::Decode.optional(raw, "summary") { |v| ::Oapi::Codec::Primitive::String::CODEC.from_wire(v) },
            bio: ::Oapi::Decode.tristate(raw, "bio") { |v| ::Oapi::Codec::Primitive::String::CODEC.from_wire(v) },
            page_size: ::Oapi::Decode.defaulted(raw, "pageSize", 20) { |v| ::Oapi::Codec::Primitive::Integer::CODEC.from_wire(v) },
            owner: ::Oapi::Decode.tristate(raw, "owner") { |v| KitchenSink::Types::User::CODEC.from_wire(v) },
            tags: ::Oapi::Decode.optional(raw, "tags") { |v| Oapi::Decode.each(v) { |item| ::Oapi::Codec::Primitive::String::CODEC.from_wire(item) } },
            meta: ::Oapi::Decode.optional(raw, "meta") { |v| KitchenSink::Types::ModMeta::CODEC.from_wire(v) },
            extra: ::Oapi::Decode.optional(raw, "extra") { |v| Oapi::Decode.values(v) { |item| ::Oapi::Codec::Primitive::Integer::CODEC.from_wire(item) } },
          )
        end
        ...
        def to_wire(value)
          ...
          wire["updatedAt"] = ::Oapi::Codec::Primitive::DateTime::CODEC.to_wire(value.updated_at)
          deleted_at = value.deleted_at
          wire["deletedAt"] = deleted_at.nil? ? nil : ::Oapi::Codec::Primitive::DateTime::CODEC.to_wire(deleted_at)
          summary = value.summary
          wire["summary"] = ::Oapi::Codec::Primitive::String::CODEC.to_wire(summary) unless summary.nil?
          bio = value.bio
          if bio.is_a?(::Oapi::Present)
            inner = bio.value
            wire["bio"] = inner.nil? ? nil : ::Oapi::Codec::Primitive::String::CODEC.to_wire(inner)
          end
          page_size = value.page_size
          wire["pageSize"] = ::Oapi::Codec::Primitive::Integer::CODEC.to_wire(page_size) unless page_size.nil?
          owner = value.owner
          ...
          tags = value.tags
          wire["tags"] = tags.map { |item| ::Oapi::Codec::Primitive::String::CODEC.to_wire(item) } unless tags.nil?
          meta = value.meta
          wire["meta"] = KitchenSink::Types::ModMeta::CODEC.to_wire(meta) unless meta.nil?
          extra = value.extra
          wire["extra"] = extra.transform_values { |item| ::Oapi::Codec::Primitive::Integer::CODEC.to_wire(item) } unless extra.nil?
          wire
        end
      end
